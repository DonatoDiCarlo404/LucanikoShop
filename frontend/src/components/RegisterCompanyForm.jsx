  ...
  return (
    ...
    <Form onSubmit={handleSubmit} className="p-3 border rounded bg-light">
      ...
      <Form.Group className="mb-3" controlId="subscription">
        ...
        <Form.Text className="text-muted">Piano annuale: €290 + IVA 22%</Form.Text>
      </Form.Group>
    ...
    <Modal show={showTermsModal} onHide={() => setShowTermsModal(false)} size="lg" scrollable>
      ...
      <Modal.Body style={{maxHeight: '70vh', overflowY: 'auto'}}>
        <ol>
          ...
          <li><b>Variazione Termini &amp; Condizioni</b><br />Lucaniko Shop si riserva il diritto di modificare, aggiornare o integrare in qualsiasi momento i presenti Termini &amp; Condizioni, per esigenze organizzative, tecniche, commerciali o normative.<br />Le modifiche avranno efficacia dalla data di pubblicazione sulla piattaforma e si intenderanno accettate dal Venditore con la prosecuzione dell'utilizzo dei servizi offerti da Lucaniko Shop.<br />Il Venditore, con la sottoscrizione dell'abbonamento annuale, dichiara di aver letto, compreso e accettato integralmente i presenti Termini &amp; Condizioni.<br />Il Venditore potrà recedere dal contratto per giusta causa, mediante comunicazione scritta a Lucaniko Shop. In caso di recesso anticipato non motivato da inadempimento della piattaforma, il corrispettivo dell'abbonamento annuale versato non sarà rimborsabile, salvo diversa disposizione di legge.<br />Resta inteso che il recesso del Venditore non comporta alcun diritto a indennizzi, risarcimenti o rimborsi ulteriori rispetto a quanto espressamente previsto nel presente contratto.</li>

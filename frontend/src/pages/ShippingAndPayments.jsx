...
const ShippingAndPayments = () => (
  <Container className="policy-container py-4">
    ...
    <p className="mb-4 text-center">Le spedizioni su Lucaniko Shop sono gestite direttamente dai Venditori.</p>

    <h5 className="mt-4 mb-2">2.1 Costi e modalità</h5>
    ...
    <h5 className="mt-4 mb-2">2.2 Ordini multi-venditore</h5>
    ...
    <h5 className="mt-4 mb-2">2.3 Problemi di consegna</h5>
    ...
    <h5 className="mt-4 mb-2">2.4 Cibi, bevande e deperibili</h5>
    ...
    <p className="mb-4 text-center">Lucaniko Shop utilizza Stripe per gestire pagamenti sicuri e affidabili.</p>

    <h5 className="mt-4 mb-2">3.1 Metodi disponibili</h5>
    ...
    <h5 className="mt-4 mb-2">3.2 Sicurezza e dati carta</h5>
    ...
    <h5 className="mt-4 mb-2">3.3 Importo e conferma</h5>
